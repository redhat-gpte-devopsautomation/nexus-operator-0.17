...
wget https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.1.4/openshift-client-linux-4.1.4.tar.gz
mkdir client
tar xzf openshift-client-linux-4.1.4.tar.gz -C client
rm -f openshift-client-linux-4.1.4.tar.gz
